...
import figure3_1 from '../../../assets/ch3/deployment_types.png'
import figure3_2 from '../../../assets/ch3/operator_running_locally.png'
import figure3_3 from '../../../assets/ch3/debug_vscode.png'
import figure3_4 from '../../../assets/ch3/attach_intellij.png'
import figure3_5 from '../../../assets/ch3/intellij_jar.png'
import figure3_6 from '../../../assets/ch3/eclipse_remote.png'
import figure3_7 from '../../../assets/ch3/core_components.png'
import figure3_8 from '../../../assets/ch3/operator_running_cluster.png'
import figure3_9 from '../../../assets/ch3/operator_scope.png'
import figure3_10 from '../../../assets/ch3/operator_service_account.png'
import figure3_11 from '../../../assets/ch3/RBAC_permission.png'
import figure3_12 from '../../../assets/ch3/cluster_wide_permission.png'
import figure3_13 from '../../../assets/ch3/scope_levels.png'
import figure3_14 from '../../../assets/ch3/scope_watch.png'
import figure3_15 from '../../../assets/ch3/ns_scope_api_limitations.png'
...
<Image src={figure3_1} alt="Figure 3.1 Deployment types for the operator"  /> 
...
<Image src={figure3_2} alt="Figure 3.2 Operator running locally"  /> 
...
<Image src={figure3_3} alt="Figure 3.3 The Start Debugging option in VS Code Run menu"  /> 
...
<Image src={figure3_4} alt="Figure 3.4 Attach to Process on the Run dropdown menu in IntelliJ"  /> 
...
<Image src={figure3_5} alt="Figure 3.5 IntelliJ Attach to the jar file java-operator-ex-dev.jar on port 5005"  /> 
...
<Image src={figure3_6} alt="Figure 3.6 Eclipse Remote Java Application configuration"  /> 
...
<Image src={figure3_7} alt="Figure 3.7 Core components required for an operator to function"  /> 
...
<Image src={figure3_8} alt="Figure 3.8 Overview for the GitOps operator installed on a Kubernetes cluster"  /> 
...
<Image src={figure3_9} alt="Figure 3.9 Operator deployed as namespace scope, multiple namespace scope, and cluster scope"  /> 
...
The reconciler process in an operator acts by requesting the Kubernetes API server. The Kubernetes operator uses a _Service Account_ to authenticate with the Kubernetes API server, as shown in Figure 3.10. In Kubernetes, service accounts represent a running process's identity. 

<Image src={figure3_10} alt="Figure 3.10 Operator uses a service account to authenticate with the Kubernetes API server"  /> 
...
<Image src={figure3_11} alt="Figure 3.11 RBAC permission assigned to the operator service account"  /> 
...
<Image src={figure3_12} alt="Figure 3.12 Operator observes changes to custom resources based on namespace scope levels"  /> 
...
<Image src={figure3_13} alt="Figure 3.13 Operator observes changes to custom resources based on namespace scope levels"  /> 
...
```
By default, the GitOps operator is set to watch all namespaces. We can deploy the GitOps operator with ClusterRole and ClusterRoleBinding to the default namespace and create a sample CR in the namespace, for example, gitops-demoapp and gitops-demoapp-second, as shown in Figure 3.14.


<Image src={figure3_14} alt="Figure 3.14 Scope of the operator can be set through the watch namespace parameter. When the watch parameter is set to namespace “A”, the Gitops operator manages “demoapp” CR in the namespace “A” boundaries. When the watch is set to All namespaces, the Gitops operator manages CR in all the namespaces."  /> 
...
<Image src={figure3_15} alt="Figure 3.15 Namespaces scope API limitation."  /> 
